...
debug_finding_td:
	dma_addr_t td_start = xhci_trb_virt_to_dma(td->start_seg, td->start_trb);
	dma_addr_t td_end = xhci_trb_virt_to_dma(td->end_seg, td->end_trb);
...
err_out:
	dma_addr_t deq = xhci_trb_virt_to_dma(ir->event_ring->deq_seg, ir->event_ring->dequeue);
