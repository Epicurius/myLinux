...
#define	XHCI_PORT_RO	(PORT_CONNECT | PORT_OC | DEV_SPEED_MASK | PORT_DEV_REMOVE)
...
#define XHCI_PORT_RW1CS	(PORT_PE | PORT_CSC | PORT_PEC | PORT_WRC | PORT_OCC | \
			 PORT_RC | PORT_PLC | PORT_CEC)
/* Bit 16 is RW; writing a '1' to it causes the link state control to be latched in. */
