...
#define PORT_LED_MASK	GENMASK(15, 14)
...
/* These bits are RW; writing a 1 clears the bit, writing a 0 sets the bit. */
#define PORTSC_RW1CS_BITS	(PORT_PE | PORT_CSC | PORT_PEC | PORT_WRC | PORT_OCC | PORT_RC | \
				 PORT_PLC | PORT_CEC)
